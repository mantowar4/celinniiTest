                ...
                <div class="tab-content sidebar-tabing" id="nav-tabContent">
                    <div class="tab-pane active" id="home" role="tabpanel">
                        <div class="media"><a href="#"> <img class="d-flex mr-3"
                            ...
                            <div class="media-body">
                                <div class="news-title">
                                    <h2 class="title-small"><a href="{{ route('news.show', ['id' => $news[0]->news_id]) }}">{{$lastnews[0]->news_title}}</a></h2>
                                </div>
                        ...
                        <div class="media"><a href="#"> <img class="d-flex mr-3"
                            ...
                            <div class="media-body">
                                <div class="news-title">
                                    <h2 class="title-small"><a href="{{ route('news.show', ['id' => $news[1]->news_id]) }}">{{$lastnews[1]->news_title}}</a></h2>
                                </div>
                                <div class="news-auther"><span class="time">1h ago</span></div>
                            </div>
                        </div>
                        <div class="media"><a href="#"> <img class="d-flex mr-3"
                            ...
                            <div class="media-body">
                                <div class="news-title">
                                    <h2 class="title-small"><a href="{{ route('news.show', ['id' => $news[2]->news_id]) }}">{{$lastnews[2]->news_title}}</a></h2>
                                </div>
                                <div class="news-auther"><span class="time">1h ago</span></div>
                            </div>
                        </div>
